...
def main():
    ...
    desc = 'Search, order, and download Planet imagery using the Planet Python SDK.'
    ...
    parser.add_argument('-it', '--item-types',
                        type=str,
                        nargs='+',
                        required=False,
                        default=['PSScene'],
    ...
    parser.add_argument('-cc', '--cloud-cover',
                        type=float,
                        required=False,
                        default=0.2,
                        dest='cloud_cover',
    ...
    logging.info(f"Process completed in {(time.time() - timer)/60:.2f} minutes.")
